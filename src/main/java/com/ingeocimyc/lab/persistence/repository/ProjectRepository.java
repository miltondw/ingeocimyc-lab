...
public interface ProjectRepository extends ListCrudRepository<ProjectEntity,Integer> {
    ...
    @Query(value = "SELECT P.TITLE, P.LOCATION, P.REFERENCE, P.DATE, " +
            ...
            "EH.WATER_WEIGHT AS WATER_WEIGHT_EH, EH.HUMIDITY AS HUMIDITY_EH, EH.OBSERVATION AS OBSERVATION_EH, EH.CYLINDER, " +
            ...
            "EL.OBSERVATION AS OBSERVATION_EL, EL.NUMERO_PRUEBA AS NUMERO_PRUEBA_EL, " +

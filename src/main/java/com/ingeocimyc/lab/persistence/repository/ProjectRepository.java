...
public interface ProjectRepository extends ListCrudRepository<ProjectEntity,Integer> {
    ...
    @Query(value = "SELECT P.TITLE, P.LOCATION, P.REFERENCE, P.DATE, " +
            "SO.NAME AS NAME,SO.LASTNAME AS LASTNAME, S.PROBE, M.MUESTRA, H.SAMPLE_WEIGHT, H.TARE_WEIGHT AS TARE_WEIGHT_H, " +
            "EH.DEPTH, EH.HUMIDITY AS HUMIDITY_EH, EH.CYLINDER, " +
            "EG.TAMICES,EG.acum, EG.arena, EG.finos, EG.grava, EG.pasa, EG.retenido, EG.sucs_data, EG.total,EG.ID,EG.MUESTRA_ID, "+
            ...
            "EL.NUMERO_PRUEBA AS NUMERO_PRUEBA_EL,EL.limite_liquido, " +
            "EP.TARE_NUMBER, EP.TARE_WEIGHT, EP.TARE_PLUS_WET_SOIL_WEIGHT, " +
            "EP.TARE_PLUS_DRY_SOIL, EP.DRY_SOIL_WEIGHT, EP.WATER_WEIGHT, EP.HUMIDITY, EP.OBSERVATION,EP.limite_plastico, EP.NUMERO_PRUEBA " +
            "FROM PROJECT AS P " +
